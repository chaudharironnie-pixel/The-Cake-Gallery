            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm">+91 77779 34474</p>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div>
                  <p className="font-semibold">@the.cake_gallery_bharuch</p>
                  <p className="text-white/60 text-sm">Follow us for latest creations</p>
                </div>
              </a>
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-blush/20 rounded-xl flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm">Bharuch, Gujarat, India</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
